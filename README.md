...
- 🚀 **[DEPLOYMENT.md](DEPLOYMENT.md)** — Пошаговый гайд по деплою с проверками (в разработке)

**Основные разделы TROUBLESHOOTING.md:**
...
- Quick reference (проверки здоровья, типичный процесс деплоя)
- Best practices
